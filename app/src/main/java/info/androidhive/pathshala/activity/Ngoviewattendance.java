...
public class Ngoviewattendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ngoviewattendance);
    ...
    private class Background extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String str) {
            ...
            if(str=="$oocd"){
                Toast.makeText(context,"Selected date is out of course duration",Toast.LENGTH_LONG).show();
            }
            else if(str=="$nlc"){
